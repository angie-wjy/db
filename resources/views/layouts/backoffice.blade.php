            ...
            <div class="sidebar-logo">
                ...
                <div class="logo-header" data-background-color="blue">
                    <a href="../index.html" class="logo">
                        <img src="/assets/logo_smile.jpg" alt="navbar brand" class="navbar-brand" height="60" />
                    </a>
                        ...
                        <li class="nav-item">
                            ...
                            <div class="collapse" id="base">
                                <ul class="nav nav-collapse">
                                    <li
                                        class="nav-item {{ request()->routeIs('admin.product.index') ? 'active' : '' }}">
                                        <a href="{{ route('admin.product.index') }}">
                                            <span class="sub-item">Products</span>
                                        </a>
                                    </li>
                                    <li
                                        class="nav-item {{ request()->routeIs('admin.product.bundle.index') ? 'active' : '' }}">
                                        <a href="{{ route('admin.product.bundle.index') }}">
                                            <span class="sub-item">Bundles</span>
                                        </a>
                                    </li>
                                    <li
                                        class="nav-item {{ request()->routeIs('admin.product_branch.index') ? 'active' : '' }}">
                                        <a href="{{ route('admin.product.branch.index') }}">
                                    ...
                                    <li
                                        class="nav-item {{ request()->routeIs('admin.product.theme.index') ? 'active' : '' }}">
                                        <a href="{{ route('admin.product.theme.index') }}">
                                            <span class="sub-item">Themes</span>
                                        </a>
                                    </li>
                                    <li
                                        class="nav-item {{ request()->routeIs('admin.product.size.index') ? 'active' : '' }}">
        ...
        <div class="main-panel">
            <div class="main-header">
                <div class="main-header-logo">
                    ...
                    <div class="logo-header" data-background-color="blue">
                        <a href="../index.html" class="logo">
                            <img src="/assets/img/logo_smile.jpg" alt="navbar brand" class="navbar-brand"
                                height="20" />
                        </a>
                        <div class="nav-toggle">
                            <button class="btn btn-toggle toggle-sidebar">
